<?php
	...
	$configPath = $_SERVER['DOCUMENT_ROOT']."/lib/lg_payment_module_pc/lgdacom"; //LG유플러스에서 제공한 환경파일("/conf/lgdacom.conf,/conf/mall.conf") 위치 지정.
          ...
          <div class="section main">
            <div class="area_main_top nopadd">
              ...
              <div class="block_title alignC">
                ...
                <p><?=$xpay->Response("LGD_BUYER",0)?>님께서 주문하신 제품이 접수되었습니다. 주문내역 및 배송정보는 <span>주문/배송조회</span>에서 확인할 수 있습니다.</p>
              </div>
            </div>
              ...
              <div class="table_block custom">
                ...
                <div class="table_block custom">
                  <div class="block_row">
                    ...
                    <div class="block_col">
                      <p><?=$xpay->Response("LGD_RECEIVER",0)?></p>
                    </div>
                  </div>
                  <div class="block_row">
                    <div class="block_col head">
                  ...
                  <div class="block_row">
                    ...
                    <div class="block_col">
                      <p><?=$xpay->Response("LGD_DELIVERYINFO",0)?></p>
                    </div>
                  </div>
                </div>
              </div>
