            ...
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td>기본 적립금</td>
                  <td>
                    <input type="text" id="default_saved_price" value="<?=$shop_info['default_saved_price'][0]?>"> 원 (회원가입시 기본 제공되는 적립금)
                  </td>
                  <td>
                ...
                <tr>
                  ...
                  <td>
                    <select id="default_delivery_priceYN">
                ...
                <tr>
                  <td>무료배송 가능금액</td>
                  <td>
                    <input type="text" id="default_free_delivery_price" value="<?=$shop_info['default_free_delivery_price'][0]?>"> 원
                  </td>
                  <td>
                    <select id="default_free_delivery_priceYN">
                      <option value="Y" <?if ($shop_info['default_free_delivery_price'][1]=="Y"){?>selected<?}?>>사용</option>
                      <option value="N" <?if ($shop_info['default_free_delivery_price'][1]=="N"){?>selected<?}?>>미사용</option>
                    </select>
                  </td>
                </tr>
              </tbody>
