...
<!-- /.navbar-static-side -->
  ...
  <div id="page-wrapper">
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12">
          <h1 class="page-header">포스트 관리</h1>
        </div>
        <!-- /.col-lg-12 -->
      </div>
      <!-- /.row -->
      <!-- /.panel-heading -->
      <button type="button" class="btn btn-outline btn-primary btn-lg" id="add_post_btn">포스트 추가</button>
      <button type="button" class="btn btn-outline btn-success btn-lg" id="list_post_btn">포스트 목록</button>
      <div class="panel-body">
        <div class="panel-body">
          <div class="table-responsive" id="add_post" style="display:none;">
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
                <tr>
                  <td>포스트 제목</td>
                  <td colspan="2">
                    <input class="form-control" id="post_title" style="width:100%">
                  </td>
                </tr>
                <tr>
                  <td>포스트 설명</td>
                ...
                <tr>
                  <td colspan="3">
                    <form action="sample.php" method="post">
                      <textarea name="post_contents"  id="post_contents" rows="10" cols="100" style="width:100%; height:412px;"></textarea>
                    </form>
                  </td>
                </tr>
              </tbody>
            </table>
            <button type="button" class="btn btn-danger btn-lg btn-block" id="submit_btn14">완 료</button>
          </div>
          <!-- /.table-responsive -->
          <div class="table-responsive" id="list_post">
            <table width="100%" class="table table-striped table-bordered table-hover" id="post_list">
            </table>
          </div>
          <!-- /.table-responsive -->
        </div>
